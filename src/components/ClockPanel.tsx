...
export default function ClockPanel({ data, onOccupationSelect }: ClockPanelProps) {
  ...
  const totalSecondsToMidnight = (24 * 3600) - (hours * 3600 + minutes * 60 + seconds)
  const minsToMidnight = Math.floor(totalSecondsToMidnight / 60)
  const secsToMidnight = totalSecondsToMidnight % 60
      ...
      <div className="clock-hero">
        ...
        <div className="clock-stage">
          <div className="clock-face">
            <svg viewBox="0 0 400 400" className="clock-svg" role="img" aria-label={`Clock reads ${data.displayTime}`}>
              ...
              <g transform={`rotate(${(seconds / 60) * 360} 200 200)`}>
        ...
        <div className="clock-readout">
          ...
          <div className="time-context">
            {minsToMidnight} min {secsToMidnight > 0 ? `${secsToMidnight} sec ` : ''}to midnight
          </div>
          <button
            type="button"
